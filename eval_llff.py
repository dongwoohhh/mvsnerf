...
for i_scene, scene in enumerate(["fern", "flower", "fortress", "horns", "leaves", "orchids", "room", "trex"]):#
    psnr,ssim,LPIPS_vgg = [],[],[]
    cmd = f'--datadir /media/hdd1/Datasets/MVSNeRF_data/mvs_training/nerf_llff_data/{scene}  \
     --dataset_name llff \
    ...
    save_as_image = True
    save_dir = '/media/hdd1/results_nerf/mvsnerf/eval/nerf_llff_data/{}'.format(scene)
    save_txt_dir = '/media/hdd1/results_nerf/mvsnerf/eval/nerf_llff_data'
