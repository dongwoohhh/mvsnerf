...
for name in "horns" "leaves" "orchids" "room" "trex"; do
    eval_scenes=${name}
    echo $eval_scenes
    
    python train_mvs_nerf_finetuning_pl.py --dataset_name llff --datadir /media/hdd1/Datasets/MVSNeRF_data/mvs_training/${eval_dataset}/${name} \
